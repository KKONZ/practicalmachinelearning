...
From the cross validated confusion matrix, we see that the accuracy for the out of sample error rate is 99.57%. 
...
Predict and format the answers for submission
