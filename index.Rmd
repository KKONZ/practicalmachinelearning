...
# Create predictor numeric matrix
...
From the cross validated confusion matrix, we see that the accuracy is 99.57% with a kappa value of 99.46%
...
#Note the answers have been intentionally not outputted but when submitted results in a 20/20 quiz score.
```
